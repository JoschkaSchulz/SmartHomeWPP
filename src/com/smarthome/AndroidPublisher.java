...
public class AndroidPublisher {
	 ...
	 *            : Port from Proxy
	 * @param topicName
	 *            : Name from Topic or Queue to deliver
	 */
	...
	public void publishToTopic() throws IOException {
		...
		// System.out.println("AndroidPublisher sending to proxy: topic:" +
		// this.topicName + ":" + this.message);
		Log.d("AndroidPublisher sending to proxy: topic:", this.topicName + ":"
				+ this.message);
		out.flush();
		sender.close();
	}
	...
	public void publishToQueue() throws IOException {
		...
		// System.out.println("AndroidPublisher sending to proxy: queue:" +
		// this.topicName + ":" + this.message);
		Log.d("AndroidPublisher sending to proxy: queue:", this.topicName + ":"
				+ this.message);
		out.flush();
		sender.close();
	}
